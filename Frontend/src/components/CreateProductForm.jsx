...
const categories = ["jeans", "t-shirts", "shoes", "glasses", "jackets", "suits", "bags","gadgets","mobile","laptop","others"];
...
const CreateProductForm = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setNewProduct({ name: "", description: "", price: "", category: "", image: "",stock:"",color:"",size:"" });
		} catch {
